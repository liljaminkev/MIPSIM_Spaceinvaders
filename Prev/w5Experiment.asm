...
main:  
	...
	addi	$a2,$0,1000		# timer interval every 1 seconds
	syscall	$IO_write
	la	$a0,timer.t2		# hardware address of timer1
	addi	$a1,$0,4		# 4 byte data
	addi	$a2,$0,200		# timer interval every .2
	syscall	$IO_write
